        ...
        <ul class="space-y-2">
            <li>
                <a href="<?= ROOTURL ?>/OrganizerController/dashboard"
                    class="flex items-center gap-3 text-textColor hover:bg-primary/20 p-3 rounded-lg transition-all nav-link <?= (isset($data['currentPage']) && $data['currentPage'] == 'dashboard') ? 'active bg-primary/20' : '' ?>">
            ...
            <li>
                <a href="<?= ROOTURL ?>/OrganizerController/createevent"
                    class="flex items-center gap-3 text-textColor hover:bg-primary/20 p-3 rounded-lg transition-all nav-link <?= (isset($data['currentPage']) && $data['currentPage'] == 'createevent') ? 'active bg-primary/20' : '' ?>">
            ...
            <li>
                <a href="<?= ROOTURL ?>/OrganizerController/events"
                    class="flex items-center gap-3 text-textColor hover:bg-primary/20 p-3 rounded-lg transition-all nav-link <?= (isset($data['currentPage']) && $data['currentPage'] == 'events') ? 'active bg-primary/20' : '' ?>">
            ...
            <li>
                <a href="<?= ROOTURL ?>/OrganizerController/tickets"
                    class="flex items-center gap-3 text-textColor hover:bg-primary/20 p-3 rounded-lg transition-all nav-link <?= (isset($data['currentPage']) && $data['currentPage'] == 'tickets') ? 'active bg-primary/20' : '' ?>">
            ...
            <li>
                <a href="<?= ROOTURL ?>/OrganizerController/profile"
                    class="flex items-center gap-3 text-textColor hover:bg-primary/20 p-3 rounded-lg transition-all nav-link <?= (isset($data['currentPage']) && $data['currentPage'] == 'profile') ? 'active bg-primary/20' : '' ?>">
